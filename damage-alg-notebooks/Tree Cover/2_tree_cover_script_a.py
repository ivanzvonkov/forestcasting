# -*- coding: utf-8 -*-
"""2_tree_cover_script_a

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CPbIC-3D4AkmnS87oDSPBYj7ZSm81Qua
"""
...
data_path = '/content/gdrive/My Drive/Capstone Public Folder/Data/'

# Create new dataset for province w/ tree cover info
prov_array = ["BC","AL","SK","MB","ON","QB","NB","NS","PE","NL","YT","NT","NU"]
province = "YT"

df =  pd.read_csv(data_path + f'{province} Location/{province}_location_grid.csv.gz", compression = 'gzip')
