...
province = 'AL'
province_lowercase = 'alberta'
province_capitalized = 'Alberta'
...
required_files = [
  f'{province_capitalized} Location /Ivan_NarrowedData/{province}_location_grid_wooded.csv.zip',
  f'{province_capitalized} Location /Shima_NarrowedData/{province}_location_grid_usefulness.csv.zip',
  f'Weather - Stations/{province_lowercase}_grid_system_with_station.csv.zip',
...
location_grid_stations = pd.read_csv(f'{province_lowercase}_grid_system_with_station.csv')
...
def add_hourly_averages(weather_row):
  hourly_weather_specific_day = hourly_weather_data.loc[
    ...
    (hourly_weather_data['Station Name'] == weather_row['Station Name'])
  ]
...
file_path = root_path + f'{province_capitalized} Location /{province}_weather_location_grid.csv.gz'
