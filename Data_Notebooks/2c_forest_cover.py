...
**Outputs:**
* {province} Location/{province}_location_grid_wooded.csv.gz
"""
...
# Set root path, may be different for everyone
...
usefulness_grid.to_csv(root_path + f'{province} Location/{province}_location_grid_wooded.csv')

files.download(f'{province}_location_grid_wooded.csv')